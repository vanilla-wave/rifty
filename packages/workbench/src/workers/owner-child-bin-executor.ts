...
import type { NodeWorkerRuntimeEnv } from './node-worker-runtime-config.ts';
...
export function buildChildSpawnSpec(
  req: BinSpawnRequest,
  nodeEntryUrl: string,
  nodeWorkerRuntimeEnv: NodeWorkerRuntimeEnv,
...
/** Apply mandatory runtime policy before optional owner-specific enrichment. */
