import { parseProjectSpec } from '../project-catalog.ts';
/**
 ...
 */
import { type BootstrapConfig, type ProjectSpec, resolveBootstrapConfig } from '../project-spec.ts';
...
export function resolveDevServerChildConfig(
  ...
  const spec = parseProjectSpec(required(env, 'RIFTY_RFV_PROJECT_SPEC'));
