...
import {
  ...
  serveProjectIndex as serveProjectIndexCore,
  setActiveIndex,
...
const PORT = 59124;
const serveProjectIndex: typeof serveProjectIndexCore = (
  key,
  fs,
  base,
  flush,
  ...
  serveProjectIndexCore(key, fs, base, flush, refresh, initializeStarterGit, TEST_PROJECT_CATALOG);
