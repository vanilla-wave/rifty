/**
 * `@riftydev/vfs/internal` — internal entry point for symbols that exist to
 * wire the runtime together but are NOT part of `@riftydev/vfs`'s stable
 * public surface.
 *
 ...
 * goal is to keep the public `@riftydev/vfs` API ({@link Vfs},
