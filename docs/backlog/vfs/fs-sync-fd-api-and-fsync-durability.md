...
created: 2026-06-12
why: M11 landed runtime-local node:fs fds and WASI positional fd syscalls without changing the public FsSync contract; true inode-like open-unlink/rename semantics and sync durability need a lower VFS fd design and ADR
sources: [M11, docs/research/open-webcontainers-alternative-2026-06.md, ADR-0072, ADR-0090]
code: [packages/vfs/src/fs-sync.ts, packages/vfs/src/sync-mirror.ts, packages/vfs/src/opfs-sync.ts]
---

## Context

The M11 runtime slice implements practical fd coverage at the runtime layer:
...
What remains is fidelity, not immediate M11 adoption: Node keeps open file
