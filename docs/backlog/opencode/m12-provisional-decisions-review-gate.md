...
## Reversibility
REVERSIBLE — each Q is a provisional decision recorded per the record-and-continue rule (CLAUDE.md, rule 5). The review itself is process, not a code fork; promotion to ADRs is the closing step. Gate: end of milestone M12.
