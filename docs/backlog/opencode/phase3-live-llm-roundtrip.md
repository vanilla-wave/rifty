...
sources: [TASKS M12 F08, docs/backlog/opencode/reference/README.md §Phase 3 / §Single next step, decisions.md ADR-0061 + C1 pre-flight, Q-2026-05-30-114/115/116, ADR-0010, ADR-0069, audit-digest]
---
## Context
...
## Reversibility
IRREVERSIBLE: ADR-0061 (supersedes immutable ADR-0010, preserving no-silent-plaintext) RATIFIES once a real endpoint+key returns a non-empty assistant reply. Confirm-first gate (outward spend/network — CLAUDE.md "confirm-first applies ONLY to actions outward-facing/destructive"). Q-114/115/116 reversible (harness env), await end-of-M12 review.
