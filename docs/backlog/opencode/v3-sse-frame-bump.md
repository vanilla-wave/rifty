...
## Reversibility
IRREVERSIBLE: non-additive bump of a versioned wire contract that CONTRADICTS an already-recorded decision (ADR-0048 D2) and amends ADR-0017 → requires a DECISION SUBAGENT producing the superseding ADR (ADR-0063 reconsideration path), not an inline call. Do not code/ship until ratified.
