...
code: [packages/shell/src/builtins.ts, packages/shell/src/tokenize.ts, packages/workbench/src/workers/real-vite-bootstrap.ts, packages/workbench/src/glue/npm-shell-command.ts]
---
