...
sources: [M11, ADR-0048, ADR-0017]
---
## Context
M11 (Consumer Ready) item — "previews that don't hang". Note: the "M12 ReadableStream rewrite" envelope cited below (ADR-0017/ADR-0048's deferral) was the streaming-rewrite milestone; it is now folded into M11 (the opencode M12 milestone was retired). The ADR text is left as historical.
