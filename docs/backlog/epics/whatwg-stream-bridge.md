...
items: [runtime-js/stream-statics-predicates-and-defaults, runtime-js/stream-writable-duplex-web-bridge, runtime-js/stream-async-iterator-helpers, runtime-js/stream-cork-uncork-writev-batching, runtime-js/stream-compose-wrap-duplex-from]
---
