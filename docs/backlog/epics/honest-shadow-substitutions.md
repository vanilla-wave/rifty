...
items: [kernel/worker-capability-ports, npm-client/shadow-asset-store, npm-client/eddy-batch-asset-closure, npm-client/esbuild-alias-override-retirement, npm-client/sass-embedded-substitution, process-meta/shadow-capsule-selective-ci, npm-client/external-shadow-registries]
---
...
wall time and tarball-body bytes are measured in the store item, never inferred
from the no-progress bound. Eddy adds only a matched row.
...
- `npm-client/shadow-asset-store` — core: exact version-to-asset declarations,
  ...
  receipts, STD transport + cold baseline, playground bundle asset removed
  (ready; ADR-0249; blocked by kernel capability ports).
