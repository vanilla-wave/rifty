...
No implementation units compiled during refine. FIT owns the next unit and
its missing reference/RED evidence; the goal remains draft.
...
- [Unreadable preload](../../vfs/opfs-preload-failure-empty-bytes.md): I3's existing read-honesty gap; reuse this capture, do not duplicate it.
