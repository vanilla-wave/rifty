...
code: [apps/playground/src/glue/project-index.ts, apps/playground/src/glue/project-index-port.ts, apps/playground/src/orchestration/save-flow.ts, apps/playground/src/orchestration/reset-refresh.ts, apps/playground/src/glue/app-project-store.ts, apps/playground/src/orchestration/project-index-boot.ts]
---
