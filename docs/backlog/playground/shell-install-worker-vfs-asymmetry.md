...
sources: [ADR-0043]
code: [apps/playground/src/App.tsx, packages/workbench/src/glue/npm-shell-command.ts, packages/workbench/src/glue/vfs-write-port.ts, packages/workbench/src/glue/sync-mirror-vfs.ts, packages/workbench/src/workers/real-vite-bootstrap.ts]
---
