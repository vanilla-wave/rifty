...
code: [packages/workbench/src/glue/package-mutation-executor.ts, packages/workbench/src/workers/package-acquisition-authority.ts, packages/workbench/src/workers/vite-cli-prep.ts, packages/workbench/src/workers/workbench-project-vfs.ts]
---
