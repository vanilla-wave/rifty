...
Related but distinct: `templates-as-stack-consumers` (adding templates), `distribution/create-rifty-template` (scaffolding a host), `baked-snapshot-regeneration` (dep snapshot), `preset-switch-port-flip-window`.
