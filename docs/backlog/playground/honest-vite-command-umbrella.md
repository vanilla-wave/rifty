...
code: [packages/workbench/src/workers/real-vite-bootstrap.ts, packages/workbench/src/glue/bin-executor.ts, packages/workbench/src/workers/owner-child-bin-executor.ts, packages/workbench/src/workers/node-entry-bootstrap.ts, packages/workbench/src/workers/vite-cli-prep.ts, packages/workbench/src/workers/vite-config-guard.ts]
---
