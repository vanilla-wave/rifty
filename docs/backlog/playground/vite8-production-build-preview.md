...
sources: [packages/workbench/src/workers/workbench-project-runtime.ts, packages/workbench/src/workers/dev-server-boot.ts, docs/adr/runtime-js/0162-vite-8-rolldown-wasi-browser-boot-runtime-surface.md, docs/public/compat/incompatible-packages.md]
code: [packages/workbench/src/workers/workbench-project-runtime.ts]
---
