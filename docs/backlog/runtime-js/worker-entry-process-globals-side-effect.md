...
code: [packages/runtime-js/src/worker-entry.ts, packages/workbench/src/workers/worker-runtime-globals.ts, packages/workbench/src/workers/kernel-worker-entry.ts]
---
