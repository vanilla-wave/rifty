...
blocked_by: [runtime-js/process-lifecycle-events-exit-code, runtime-js/worker-threads-handle-keepalive, runtime-js/worker-threads-stdio-streams-empty-exec-argv]
