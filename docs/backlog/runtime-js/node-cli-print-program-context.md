...
sources: [M11, ADR-0267, docs/adr/runtime-js/0339-node-eval-script-launch-over-node-entry-v3.md, docs/backlog/runtime-js/reference/node-v24.16.0-cli-eval-probe.md]
...
the shipped CommonJS eval path in ADR-0339.
...
adding a permissive field or side channel contradicts ADR-0267/0339. Rifty
therefore throws
