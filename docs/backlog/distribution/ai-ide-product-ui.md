...
sources: [M12, docs/backlog/distribution/ai-ide-pi-agent-harness.md, docs/adr/distribution/0224-framework-free-workbench-session-controllers-package.md, docs/backlog/distribution/framework-bindings-kit.md]
---

## Context

Generic IDE atoms (editor / terminal / preview / filetree) stay in rifty (ADR-0224
workbench controllers + the EPIC D framework-bindings kit). The agent-specific surface — chat panel,
