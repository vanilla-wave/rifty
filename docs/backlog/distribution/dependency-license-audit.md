...
created: 2026-06-12
why: first-party MIT position is documented, but transitive dependency licence audit is broader compliance work and should not block the M11 positioning page
sources: [M11, docs/public/open-runtime-position.md, docs/research/open-webcontainers-alternative-2026-06.md]
code: [package.json, pnpm-lock.yaml, packages, tools/shadow-registry]
---

## Context

M11's public open-runtime position now lives in `docs/public/open-runtime-position.md`: first-party
...
a release checklist, a generated report, or a CI warning. Do not block the M11 positioning page on
this audit.
