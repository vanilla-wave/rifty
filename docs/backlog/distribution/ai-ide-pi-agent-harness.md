...
sources: [M12, docs/research/open-webcontainers-alternative-2026-06.md, docs/backlog/distribution/public-api-ai-agent-exec-preview.md, docs/backlog/distribution/public-api-ai-agent-contract-snapshot-restore.md, docs/adr/distribution/0263-workbench-playground-companion-subpath.md]
