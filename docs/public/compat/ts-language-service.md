...
| Project's installed TS version (workspace version) | ✅ | Requires `node_modules/typescript/lib/typescript.js` + adjacent `lib/*.d.ts` from the project; missing or broken workspace TypeScript fails loudly (ADR-0177) |
