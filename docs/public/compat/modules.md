...
| tsconfig `paths` aliases | ✅ | Explicit absolute `paths` map (ADR-0066). Automatic discovery removed (ADR-0380); enabling the retired option throws `NotImplementedError` |
