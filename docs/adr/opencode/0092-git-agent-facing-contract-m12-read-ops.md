...
> TL;DR: M12 opencode bash channel serves git status/diff/log as structured facade-tool read-ops (isomorphic-git read, no spawn), write-ops throw NotImplementedError + compat ❌, impl deferred
