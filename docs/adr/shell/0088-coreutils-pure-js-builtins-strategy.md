...
> TL;DR: grow the shell command surface via zero-dep pure-JS builtins over the VFS sync mirror; reject busybox.wasm (GPL/Emscripten), defer uutils-WASM and picomatch behind verified-need future ADRs
