...
> Correction (2026-07-21, ADR-0303): surviving direct identities reserve their
> root-visible flat slots before traversal. First-wins-flat remains the serial,
> request-ordered rule among descendants; all other nested-placement clauses stand.
