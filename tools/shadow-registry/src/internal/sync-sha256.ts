// ADR-0312-SYNC-SHA256-CORE: shadow-registry.
...
/** The one synchronous SHA-256 core in the shadow-registry layer (ADR-0312). */
export function shadowSha256(value: string | Uint8Array): string {
