...
- Sass closure oracle refreshed against the live registry (2026-08-07):
  ...
  sass-vite node-build oracle + package-lock fixture regenerated by the real
  Node run (also picks up nanoid 3.3.17, postcss 8.5.26). Version pins in the
  npm-client installer contract test follow.
