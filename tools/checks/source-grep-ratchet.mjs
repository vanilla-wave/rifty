...
export const ALLOWLIST = [
  { file: 'apps/playground/src/App.test.ts', count: 432 },
  ...
  { file: 'apps/playground/src/components/BottomPanel.test.ts', count: 2 },
  ...
  { file: 'apps/playground/src/components/TerminalPanel.test.ts', count: 6 },
