...
export const BASELINE = [
  ...
  { file: 'packages/runtime-js/src/module-loader/esm.ts', max: 1916 },
  ...
  { file: 'packages/vfs/src/opfs-sync.ts', max: 1159 },
  ...
  { file: 'packages/runtime-js/src/module-loader/esm-ast.ts', max: 948 },
  ...
  { file: 'packages/runtime-js/src/module-loader/loader.ts', max: 827 },
