...
export const BASELINE = [
  ...
  { file: 'packages/workbench/src/workers/playground-project-authority.ts', max: 2487 },
  ...
  { file: 'packages/workbench/src/workers/package-acquisition-authority.ts', max: 1388 },
