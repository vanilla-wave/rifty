...
const c: ParityCase = {
  code: `
    ...
    const registered = Symbol.for('rifty.parity.symbol-writes.cjs');
    globalThis[key] = 1;
    ...
    Object.defineProperty(globalThis, Symbol.for('rifty.parity.symbol-inline.cjs'), { value: 11, configurable: true });
    console.log('inline', globalThis[Symbol.for('rifty.parity.symbol-inline.cjs')]);
    const trace = [];
    ...
    Reflect.deleteProperty(globalThis, Symbol.for('rifty.parity.symbol-inline.cjs'));
  `,
  expected:
    'assign 1\nupdate 4\ndefine 5\ndescriptors 6\nreflect 8\nobject 9\ngetter 10\ninline 11\norder key,value 12\nmutable 13\nshadow 14\ndelete true true\n',
};
