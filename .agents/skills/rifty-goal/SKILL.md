...
|---|---|
| No goal dir — a hand-off naming an outcome, or a legacy single-file epic — or a `draft` goal dir (e.g. left on an unanswered user question or a just-file) | FIT → `docs/process/stages/fit.md` |
