...
- Target: a raw idea (no doc yet) or one `draft` item/epic — not a ready parent. A `ready` item with a live fork is demoted first (`decision-workflow.md` §Backlog readiness).
