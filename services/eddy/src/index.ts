...
// API compatibility: `@riftydev/eddy`'s `closureHashOf` has always returned a
// plain `string` — the sync Node twin of the shared async implementation
// (`closure-hash.ts` hashes the same `canonicalClosureJson`).
